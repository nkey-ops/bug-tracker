...
@Component
public class TicketRecordModelAssembler
    implements RepresentationModelAssembler<TicketRecordDTO, TicketRecordResponseModel> {
  ...
  public TicketRecordResponseModel toModel(TicketRecordDTO ticketRecordDTO) {
    ...
    ticketRecord.add(
        linkTo(
                methodOn(UserViewController.class)
                    .getUserPage(ticketRecord.getCreator().getPublicId()))
            .withRel("creatorPage"),
        linkTo(
  ...
  public DataTablesOutput<TicketRecordResponseModel> toDataTablesOutputModel(
      DataTablesOutput<TicketRecordDTO> input) {
