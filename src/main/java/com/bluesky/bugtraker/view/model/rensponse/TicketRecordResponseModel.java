...
public class TicketRecordResponseModel extends RepresentationModel<TicketResponseModel> {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), publicId, status, severity, priority, shortDescription, howToReproduce, erroneousProgramBehaviour, howToSolve, createdTime, mainTicket, creator);
    }
}
