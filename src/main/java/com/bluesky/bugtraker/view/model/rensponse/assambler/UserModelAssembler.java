...
public class UserModelAssembler
    implements RepresentationModelAssembler<UserDTO, UserResponseModel> {
  ...
  public DataTablesOutput<UserResponseModel> toDataTablesOutputModel(
      DataTablesOutput<UserDTO> input) {
