...
public class TicketRequestModel {
    ...
    @NotEmpty
    @Size(min = 4, max = 5000,
            message = "How to Reproduce description length should be not less than 4 characters and no more than 5000")
    private String howToReproduce;
   
    @NotEmpty
    @Size(min = 4, max = 5000,
            message = "Erroneous Program Behaviour length should be not less than 4 characters and no more than 5000")
    private String erroneousProgramBehaviour;

    @Size(max = 5000,
            message = "Solution length should not be more than 5000")
