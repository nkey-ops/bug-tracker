...
public class TicketViewController {
  ...
  public TicketViewController(
      UserController userController, TicketAccessEvaluator ticketAccessEvaluator) {
  ...
  public ModelAndView getTicketPage(
      @PathVariable String creatorId,
      @PathVariable String projectId,
      @PathVariable String ticketId) {

    ModelAndView modelAndView = new ModelAndView("pages/tickets/ticket");
    WebMvcLinkBuilder ticketLink =
        linkTo(methodOn(TicketController.class).getTicket(creatorId, projectId, ticketId));

    String projectPageLink =
        linkTo(methodOn(ProjectViewController.class).getProjectPage(creatorId, projectId))
            .toString();
    String subscribersSourceLink =
        linkTo(
                methodOn(TicketController.class)
                    .getSubscribers(creatorId, projectId, ticketId, null))
            .toString();
    ...
    String ticketSubscribersLink =
        linkTo(
                methodOn(TicketViewController.class)
                    .getSubscribersBody(creatorId, projectId, ticketId))
            .toString();
    String userPageLink =
    ...
    boolean areCommentsAllowed =
        ticketAccessEvaluator.areCommentsAllowed(currentUser.getPublicId(), creatorId, ticketId);
    boolean isUserSubscribed =
        ticketAccessEvaluator.isUserSubscribed(currentUser.getPublicId(), ticketId);
  ...
  @GetMapping("/creation")
  public String getTicketCreationPage(
    ...
    UserResponseModel currentUser = userController.getCurrentUser();
    String userPageLink =
        linkTo(methodOn(UserViewController.class).getUserPage(currentUser.getPublicId()))
            .toString();
  ...
  public String getTicketEditionPage(
      @PathVariable String creatorId,
      @PathVariable String projectId,
      @PathVariable String ticketId,
      Model model) {
    ...
    String ticketPageLink =
        linkTo(methodOn(TicketViewController.class).getTicketPage(creatorId, projectId, ticketId))
            .toString();
    String userPageLink =
        linkTo(methodOn(UserViewController.class).getUserPage(currentUser.getPublicId()))
            .toString();
  ...
  public ModelAndView getTicketDetails(
    ...
    boolean isEditionAllowed =
        ticketAccessEvaluator.isTicketEditionAllowed(
            currentUser.getPublicId(), creatorId, ticketId);
  ...
  @GetMapping("/body")
  public ModelAndView getTicketsBody(
  ...
  public String getTicketContentBlock(
      @PathVariable String creatorId, @PathVariable String projectId, Model model) {
  ...
  public String getTicketEditForm(
      @PathVariable String creatorId,
      @PathVariable String projectId,
      @PathVariable String ticketId,
      Model model) {
  ...
  public ModelAndView getTicketRecordDetails(
      @PathVariable String creatorId,
      @PathVariable String projectId,
      @PathVariable String ticketId,
    ...
    String ticketRecordLink =
        linkTo(
                methodOn(TicketController.class)
                    .getTicketRecord(creatorId, projectId, ticketId, recordId))
            .toString();
  ...
  public String getTicketRecordsBody(
      @PathVariable String creatorId,
      @PathVariable String projectId,
      @PathVariable String ticketId,
      Model model) {
  ...
  public String getTicketRecordsContentBlock(
      @PathVariable String creatorId,
      @PathVariable String projectId,
      @PathVariable String ticketId,
      Model model) {
  ...
  public ModelAndView getSubscribersBody(
      @PathVariable String creatorId,
      @PathVariable String projectId,
      @PathVariable String ticketId) {
