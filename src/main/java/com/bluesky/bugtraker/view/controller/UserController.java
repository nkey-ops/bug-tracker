...
public class UserController {
  ...
  public ResponseEntity<?> updateUser(
      @PathVariable String userId, @Valid UserRequestModel userRequestModel) {
  ...
  @GetMapping
  public ResponseEntity<DataTablesOutput<UserResponseModel>> getUsers(
      @Valid DataTablesInput input) {

    DataTablesOutput<UserDTO> userDTOs = userService.getUsers(input);
    DataTablesOutput<UserResponseModel> assembledUsers =
        userModelAssembler.toDataTablesOutputModel(userDTOs);
  ...
  public ResponseEntity<DataTablesOutput<ProjectResponseModel>> getSubscribedToProjects(
      @PathVariable String userId, @Valid DataTablesInput input) {
