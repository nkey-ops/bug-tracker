...
public class ProjectController {
  ...
  public ResponseEntity<?> createProject(
      @PathVariable String creatorId, @Valid ProjectRequestModel projectRequestModel) {
  ...
  public ResponseEntity<DataTablesOutput<ProjectResponseModel>> getProjects(
      @PathVariable String creatorId, @Valid DataTablesInput input) {
  ...
  @PreAuthorize("hasRole('SUPER_ADMIN') or" + "#creatorId == principal.id")
  @PatchMapping(value = "/{projectId}", consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
  ...
  public ResponseEntity<DataTablesOutput<UserResponseModel>> getSubscribers(
    ...
    DataTablesOutput<UserDTO> pagedSubsDTOs = projectService.getSubscribers(projectId, input);
  ...
  public ModelAndView getComments(
    ...
    List<CommentDTO> pagedCommentsResponseModel =
        modelMapper.map(
            pagedCommentsDto.getContent(), new TypeToken<ArrayList<CommentDTO>>() {}.getType());
