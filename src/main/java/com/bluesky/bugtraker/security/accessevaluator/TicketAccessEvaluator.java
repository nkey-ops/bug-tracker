...
public class TicketAccessEvaluator {
  ...
  public boolean areCommentsAllowed(
      @NotNull String principalId, @NotNull String creatorId, @NotNull String ticketId) {
    return creatorId.equals(principalId)
        || userServiceImp.isSubscribedToTicket(principalId, ticketId);
  }

  public boolean isTicketEditionAllowed(
      @NotNull String principalId, @NotNull String creatorId, @NotNull String ticketId) {
    return creatorId.equals(principalId)
        || userServiceImp.isSubscribedToTicket(principalId, ticketId);
  }
