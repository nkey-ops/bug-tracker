...
public class EmailService {
  ...
  public EmailService(ITemplateEngine templateEngine, JavaMailSender emailSender) {
  ...
  /**
   * Verifies an email address by sending to it a verification mail with a unique verification link
   *
   ...
   * @return HTML page with email verification link that is built from current context path and
