...
public class EnumSerializationTest {
  ...
  void roleSerialization(Role role) throws JsonProcessingException {
    ...
    assertTrue(
        serializedRole.contains(role.getName()), "Json should contain name:" + role.getName());
    assertTrue(
        serializedRole.contains(role.getText()), "Json should contain text:" + role.getText());
  ...
  void statusSerialization(Status status) throws JsonProcessingException {
    ...
    assertTrue(
        serializedStatus.contains(status.getName()),
        "Json should contain name:" + status.getName());
    assertTrue(
        serializedStatus.contains(status.getText()),
  ...
  void severitySerialization(Severity severity) throws JsonProcessingException {
    ...
    assertTrue(
        serializedSeverity.contains(severity.getName()),
        "Json should contain name:" + severity.getName());
    assertTrue(
        serializedSeverity.contains(severity.getText()),
  ...
  void severitySerialization(Priority priority) throws JsonProcessingException {
    ...
    assertTrue(
        serializedPriority.contains(priority.getName()),
        "Json should contain name:" + priority.getName());
    assertTrue(
        serializedPriority.contains(priority.getText()),
